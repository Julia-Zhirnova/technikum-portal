...
- Name: tests/student_profile.spec.ts >> Блок 2.1: Профиль студента >> 2.1.5.2: Автосохранение черновика каждые 30 секунд
- Location: tests/student_profile.spec.ts:48:3
