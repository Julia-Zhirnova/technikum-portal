...
- Name: tests/student_profile.spec.ts >> Блок 2.1.3: Здоровье >> 2.1.3.2: Чекбокс "Полиса ОМС нет" блокирует поля ОМС
- Location: tests/student_profile.spec.ts:140:3
...
Call log:
  - waiting for locator('[data-testid="no-oms-checkbox"]')
