...
- Name: tests/student_profile.spec.ts >> Блок 2.1.2: Паспорт >> 2.1.2.1: Чекбокс "Иностранный гражданин" меняет маску
- Location: tests/student_profile.spec.ts:87:3
...
Call log:
  - waiting for locator('[data-testid="foreign-citizen-checkbox"]')
