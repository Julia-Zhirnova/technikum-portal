...
- Name: tests/student_profile.spec.ts >> Блок 2.1: Профиль студента >> 2.1.1.1: Маска СНИЛС автоматически форматирует ввод
- Location: tests/student_profile.spec.ts:14:3
