...
- Name: tests/student_profile.spec.ts >> Блок 2.1.2: Паспорт >> 2.1.2.2: Кнопка "Совпадает с регистрацией" копирует адрес
- Location: tests/student_profile.spec.ts:97:3
...
Call log:
  - waiting for locator('[data-testid="registration-address-input"]')
