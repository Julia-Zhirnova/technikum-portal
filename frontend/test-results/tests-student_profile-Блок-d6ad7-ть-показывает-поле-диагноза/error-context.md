...
- Name: tests/student_profile.spec.ts >> Блок 2.1.3: Здоровье >> 2.1.3.1: Выбор "Имею инвалидность" показывает поле диагноза
- Location: tests/student_profile.spec.ts:131:3
...
Call log:
  - waiting for locator('[data-testid="health-status-select"]')
