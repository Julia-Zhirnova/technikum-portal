...
- Name: tests/student_profile.spec.ts >> Блок 2.1: Профиль студента >> 2.1.1.4: Чекбокс согласия на ПДн заполняет дату автоматически
- Location: tests/student_profile.spec.ts:39:3
...
Call log:
  - waiting for locator('[data-testid="pd-consent-checkbox"]')
